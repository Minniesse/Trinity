...
class our_Trinity extends StatefulWidget {
  final String name;
  final CameraDescription? camera;
  const our_Trinity({super.key, this.camera, required this.name});

  @override
  State<our_Trinity> createState() => _our_TrinityState();
}

class _our_TrinityState extends State<our_Trinity> {
  @override
